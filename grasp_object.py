...
def main(
    ...
    print(f"Announcing intention to grasp: {target_object}")


    demo.robot_say(f"Got it. I am looking for the {target_object} now.") 
    ...
    print("Task finished. Waiting for human to take the object...")
    demo.robot_say("I have the object. Please take it. Releasing in two seconds.")
    time.sleep(5)  
    robot.open_gripper()
